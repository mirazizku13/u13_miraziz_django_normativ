...
#         # migrated_files = cursor.fetchall()
#
#         for i in cursor.fetchall():
#             migrated.append(i[0])
#         print(migrated)
#
#         for fileneame in files:
#             if not fileneame in migrated:
#                 files_to_mirgrate.append(fileneame)
#
#     for filename in files_to_mirgrate:
...
#                 cursor.execute(sql)
#
#             print('applied {}'.format(filename))
#
#             with DBManager() as cursor:
#                 cursor.execute("""insert into migrations (failname) VALUES (%s)""",(filename,))
...
# print(os.listdir(MIGRATIONS_PATH))
